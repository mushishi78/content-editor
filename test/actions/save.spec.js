...
describe('save', function() {
  const location = { owner: 'NeoDude', repo: 'Lazerly', branch: 'master', path: 'app.rb' },
  ...
  beforeEach(function() {
    ...
    this.getState = sinon.stub().returns({ location, github: this.github, file: { content } });
  });
  ...
  it('writes and dispatches complete', function() {
    ...
    assert(this.github.write.calledWith(location, content, comment));
